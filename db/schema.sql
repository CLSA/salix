...
-- Wed 24 Jan 2018 04:50:06 PM EST
...
-- -----------------------------------------------------
-- Table `salix`.`apex_scan_code_summary`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `salix`.`apex_scan_code_summary` ;

CREATE TABLE IF NOT EXISTS `salix`.`apex_scan_code_summary` (
  `apex_scan_id` INT UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- procedure update_apex_scan_code_summary
-- -----------------------------------------------------

USE `salix`;
DROP procedure IF EXISTS `salix`.`update_apex_scan_code_summary`;
